		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App7",
									"targetURL": "#comhemanthappsproject7-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhemanthappsproject7-display": {
								"semanticObject": "comhemanthappsproject7",
								"action": "display",
								"description": "Master Detail using nested views",
								"title": "App7",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hemanth.apps.project7",
									"url": sap.ui.require.toUrl("com/hemanth/apps/project7")
								}
							}
						}
					}
